...
//import CustomNotificationCompactExtras;
...
// */
//public class CustomNotificationCompact {
//
//    /**
...
//     * {@link CustomNotificationCompact.Builder#setSound}
//     *
//     * <p>
...
//     * </p>
//     *
//     * @see CustomNotificationCompact.Builder#setDefaults
//     */
//    public static final int DEFAULT_SOUND = 1;
//
//    /**
//     * Use the default notification vibrate. This will ignore any vibrate set using
//     * {@link CustomNotificationCompact.Builder#setVibrate}. Using phone vibration requires the
...
//     * {@link #FLAG_SHOW_LIGHTS} bit, and values set with {@link CustomNotificationCompact.Builder#setLights}.
//     *
//     * @see CustomNotificationCompact.Builder#setDefaults
//     */
...
//     *
//     * @deprecated Use {@link CustomNotificationCompact.Builder#setPriority(int)} with a positive value.
//     */
//    @Deprecated
...
//     * {@link CustomNotificationCompact.Builder#setGroup}.
//     */
...
//     * {@link CustomNotificationCompact.Builder#setBubbleMetadata(CustomNotificationCompact.BubbleMetadata)} to request that a
...
//
//    /**
//     * Default notification priority for {@link CustomNotificationCompact.Builder#setPriority(int)}.
...
//
//    /**
//     * Lower notification priority for {@link CustomNotificationCompact.Builder#setPriority(int)},
...
//
//    /**
//     * Lowest notification priority for {@link CustomNotificationCompact.Builder#setPriority(int)};
...
//
//    /**
//     * Higher notification priority for {@link CustomNotificationCompact.Builder#setPriority(int)},
...
//
//    /**
//     * Highest notification priority for {@link CustomNotificationCompact.Builder#setPriority(int)},
...
//     * as supplied to {@link CustomNotificationCompact.Builder#setContentTitle(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * form, e.g. as supplied to {@link CustomNotificationCompact.BigTextStyle#setBigContentTitle(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.Builder#setContentText(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.Builder#setSubText(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.Builder#setRemoteInputHistory(CharSequence[])}.
//     *
//     * Apps can fill this through {@link CustomNotificationCompact.Builder#setRemoteInputHistory(CharSequence[])}
...
//     *
//     * @see CustomNotificationCompact.Builder#setRemoteInputHistory(CharSequence[])
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.Builder#setContentInfo(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.BigTextStyle#setSummaryText(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.BigTextStyle} notification, as supplied to
//     * {@link CustomNotificationCompact.BigTextStyle#bigText(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * as supplied to {@link CustomNotificationCompact.Builder#setSmallIcon(int)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * supplied to {@link CustomNotificationCompact.Builder#setLargeIcon(android.graphics.Bitmap)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.Builder#setLargeIcon(android.graphics.Bitmap)} when the notification is
//     * shown in its expanded form, as supplied to
//     * {@link CustomNotificationCompact.BigPictureStyle#bigLargeIcon(android.graphics.Bitmap)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.Builder#setProgress(int, int, boolean)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//
//    /**
//     * {@link #getExtras extras} key: whether the when field set using {@link CustomNotificationCompact.Builder#setWhen}
//     * should be shown as a count-up timer (specifically a {@link android.widget.Chronometer})
//     * instead of a timestamp, as supplied to {@link CustomNotificationCompact.Builder#setUsesChronometer(boolean)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * supplied to {@link CustomNotificationCompact.Builder#setColorized(boolean)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//    /**
//     * {@link #getExtras extras} key: whether the when field set using {@link CustomNotificationCompact.Builder#setWhen}
//     * should be shown, as supplied to {@link CustomNotificationCompact.Builder#setShowWhen(boolean)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
//    public static final String EXTRA_SHOW_WHEN = "android.showWhen";
//
//    /**
//     * {@link #getExtras extras} key: this is a bitmap to be shown in {@link CustomNotificationCompact.BigPictureStyle}
//     * expanded notifications, supplied to
//     * {@link CustomNotificationCompact.BigPictureStyle#bigPicture(android.graphics.Bitmap)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.BigPictureStyle#bigPicture(Bitmap)}, supplied to
//     * {@link CustomNotificationCompact.BigPictureStyle#setContentDescription(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//     * {@link CustomNotificationCompact.BigPictureStyle#bigPicture(Bitmap) big picture} is to be shown in the collapsed state
//     * of a {@link CustomNotificationCompact.BigPictureStyle} notification.  This will replace a
//     * {@link CustomNotificationCompact.Builder#setLargeIcon(Bitmap) large icon} in that state if one was provided.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//
//    /**
//     * {@link #getExtras extras} key: An array of CharSequences to show in {@link CustomNotificationCompact.InboxStyle}
//     * expanded notifications, each of which was supplied to
//     * {@link CustomNotificationCompact.InboxStyle#addLine(CharSequence)}.
//     */
//    @SuppressLint("ActionValue")  // Field & value copied from android.app.Notification
...
//    /**
//     * {@link #getExtras extras} key: A string representing the name of the specific
//     * {@link CustomNotificationCompact.Style} used to create this notification.
//     */
...
//     * {@link CustomNotificationCompact.Builder#addPerson(String)}.
//     *
...
//
//    /**
//     * Key for compat's {@link CustomNotificationCompact.MessagingStyle#getConversationTitle()}. This allows backwards support
...
//     * {@link CustomNotificationCompact.Builder#setSmallIcon(int)} to represent this notification.
//     */
//    public static final int BADGE_ICON_SMALL = Notification.BADGE_ICON_SMALL;
//
//    /**
//     * If this notification is being shown as a badge, use the icon provided to
//     * {@link CustomNotificationCompact.Builder#setLargeIcon(Bitmap)} to represent this notification.
//     */
...
//
//    /**
//     * Constant for {@link CustomNotificationCompact.Builder#setGroupAlertBehavior(int)}, meaning that all notifications in a
...
//
//    /**
//     * Constant for {@link CustomNotificationCompact.Builder#setGroupAlertBehavior(int)}, meaning that the summary
...
//
//    /**
//     * Constant for the {@link CustomNotificationCompact.Builder#setGroup(String) group key} that's added to notifications
//     * that are not already grouped when {@link CustomNotificationCompact.Builder#setNotificationSilent()} is used when
...
//
//    /**
//     * Constant for {@link CustomNotificationCompact.Builder#setForegroundServiceBehavior(int)}. In Android 12 or later,
...
//     *
//     * @see CustomNotificationCompact.Builder#setForegroundServiceBehavior(int)
...
//        /** @hide */
//        @RestrictTo(LIBRARY_GROUP_PREFIX)
//        public ArrayList<CustomNotificationCompact.Action> mActions = new ArrayList<>();
//
//        /** @hide */
//        @RestrictTo(LIBRARY_GROUP_PREFIX)
//        @NonNull
...
//        ArrayList<CustomNotificationCompact.Action> mInvisibleActions = new ArrayList<>();
//
...
//        CustomNotificationCompact.Style mStyle;
...
//        @CustomNotificationCompact.NotificationVisibility
...
//        long mTimeout;
//        @CustomNotificationCompact.GroupAlertBehavior
//        int mGroupAlertBehavior = GROUP_ALERT_ALL;
//        @CustomNotificationCompact.ServiceNotificationBehavior
//        int mFgsDeferBehavior = FOREGROUND_SERVICE_DEFAULT;
//        boolean mAllowSystemGeneratedContextualActions;
//        CustomNotificationCompact.BubbleMetadata mBubbleMetadata;
...
//            final CustomNotificationCompact.Style style = CustomNotificationCompact.Style.extractStyleFromNotification(notification);
//            this.setContentTitle(CustomNotificationCompact.getContentTitle(notification))
//                    .setContentText(CustomNotificationCompact.getContentText(notification))
//                    .setContentInfo(CustomNotificationCompact.getContentInfo(notification))
//                    .setSubText(CustomNotificationCompact.getSubText(notification))
//                    .setSettingsText(CustomNotificationCompact.getSettingsText(notification))
//                    .setStyle(style)
//                    .setContentIntent(notification.contentIntent)
//                    .setGroup(CustomNotificationCompact.getGroup(notification))
//                    .setGroupSummary(CustomNotificationCompact.isGroupSummary(notification))
//                    .setLocusId(CustomNotificationCompact.getLocusId(notification))
//                    .setWhen(notification.when)
//                    .setShowWhen(CustomNotificationCompact.getShowWhen(notification))
//                    .setUsesChronometer(CustomNotificationCompact.getUsesChronometer(notification))
//                    .setAutoCancel(CustomNotificationCompact.getAutoCancel(notification))
//                    .setOnlyAlertOnce(CustomNotificationCompact.getOnlyAlertOnce(notification))
//                    .setOngoing(CustomNotificationCompact.getOngoing(notification))
//                    .setLocalOnly(CustomNotificationCompact.getLocalOnly(notification))
//                    .setLargeIcon(notification.largeIcon)
//                    .setBadgeIconType(CustomNotificationCompact.getBadgeIconType(notification))
//                    .setCategory(CustomNotificationCompact.getCategory(notification))
//                    .setBubbleMetadata(CustomNotificationCompact.getBubbleMetadata(notification))
...
//                            CustomNotificationCompact.getHighPriority(notification))
...
//                    .setColor(CustomNotificationCompact.getColor(notification))
//                    .setVisibility(CustomNotificationCompact.getVisibility(notification))
//                    .setPublicVersion(CustomNotificationCompact.getPublicVersion(notification))
//                    .setSortKey(CustomNotificationCompact.getSortKey(notification))
...
//                    .setAllowSystemGeneratedContextualActions(CustomNotificationCompact
...
//                    this.addAction(CustomNotificationCompact.Action.Builder.fromAndroidAction(action).build());
//                }
//            }
//            // Add invisible actions from the notification.
//            if (Build.VERSION.SDK_INT >= 21) {
//                List<CustomNotificationCompact.Action> invisibleActions =
//                        CustomNotificationCompact.getInvisibleActions(notification);
//                if (!invisibleActions.isEmpty()) {
//                    for (CustomNotificationCompact.Action invisibleAction : invisibleActions) {
...
//                @NonNull Notification notification, @Nullable CustomNotificationCompact.Style style) {
...
//            Bundle carExtenderExtras = newExtras.getBundle(CustomNotificationCompact.CarExtender.EXTRA_CAR_EXTENDER);
//            if (carExtenderExtras != null) {
//                carExtenderExtras = new Bundle(carExtenderExtras);
//                carExtenderExtras.remove(CustomNotificationCompact.CarExtender.EXTRA_INVISIBLE_ACTIONS);
//                newExtras.putBundle(CustomNotificationCompact.CarExtender.EXTRA_CAR_EXTENDER, carExtenderExtras);
//            }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setWhen(long when) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setShowWhen(boolean show) {
//            mShowWhen = show;
//            return this;
//        }
//
...
//        @RequiresApi(23)
//        public @NonNull
//        CustomNotificationCompact.Builder setSmallIcon(@NonNull IconCompat icon) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setUsesChronometer(boolean b) {
//            mUseChronometer = b;
//            return this;
//        }
//
...
//        @RequiresApi(24)
//        public @NonNull
//        CustomNotificationCompact.Builder setChronometerCountDown(boolean countsDown) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSmallIcon(int icon) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSmallIcon(int icon, int level) {
//            mNotification.icon = icon;
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.Builder setNotificationSilent() {
//            mSilent = true;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSilent(boolean silent) {
//            mSilent = silent;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setContentTitle(@Nullable CharSequence title) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setContentText(@Nullable CharSequence text) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSubText(@Nullable CharSequence text) {
...
//         *
//         * <p>This text does not appear within notification {@link CustomNotificationCompact.Style templates} but may
...
//         */
//        @NonNull
//        public CustomNotificationCompact.Builder setSettingsText(@Nullable CharSequence text) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setRemoteInputHistory(@Nullable CharSequence[] text) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setNumber(int number) {
//            mNumber = number;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setContentInfo(@Nullable CharSequence info) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setProgress(int max, int progress, boolean indeterminate) {
//            mProgressMax = max;
//            mProgress = progress;
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setContent(@Nullable RemoteViews views) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setContentIntent(@Nullable PendingIntent intent) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setDeleteIntent(@Nullable PendingIntent intent) {
...
//        @SuppressWarnings("deprecation")
//        @NonNull
//        public CustomNotificationCompact.Builder setFullScreenIntent(@Nullable PendingIntent intent,
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setTicker(@Nullable CharSequence tickerText) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setLargeIcon(@Nullable Bitmap icon) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSound(@Nullable Uri sound) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSound(@Nullable Uri sound, @CustomNotificationCompact.StreamType int streamType) {
//            mNotification.sound = sound;
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setVibrate(@Nullable long[] pattern) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setLights(@ColorInt int argb, int onMs, int offMs) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setOngoing(boolean ongoing) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setColorized(boolean colorize) {
//            mColorized = colorize;
//            mColorizedSet = true;
//            return this;
//        }
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setOnlyAlertOnce(boolean onlyAlertOnce) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setAutoCancel(boolean autoCancel) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setLocalOnly(boolean b) {
//            mLocalOnly = b;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setCategory(@Nullable String category) {
//            mCategory = category;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setDefaults(int defaults) {
...
//         *     the priority constants defined by {@link CustomNotificationCompact}.
//         *     Acceptable values range from {@link CustomNotificationCompact#PRIORITY_MIN} (-2) to
//         *     {@link CustomNotificationCompact#PRIORITY_MAX} (2).
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setPriority(int pri) {
//            mPriority = pri;
//            return this;
//        }
//
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.Builder addPerson(@Nullable String uri) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder addPerson(@Nullable final Person person) {
//            if (person != null) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder clearPeople() {
//            mPersonList.clear();
//            mPeople.clear();
//            return this;
//        }
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setGroup(@Nullable String groupKey) {
//            mGroupKey = groupKey;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setGroupSummary(boolean isGroupSummary) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setSortKey(@Nullable String sortKey) {
//            mSortKey = sortKey;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder addExtras(@Nullable Bundle extras) {
//            if (extras != null) {
//                if (mExtras == null) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setExtras(@Nullable Bundle extras) {
//            mExtras = extras;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder addAction(int icon, @Nullable CharSequence title,
//                                                               @Nullable PendingIntent intent) {
//            mActions.add(new CustomNotificationCompact.Action(icon, title, intent));
//            return this;
//        }
//
//        /**
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder addAction(@Nullable CustomNotificationCompact.Action action) {
//            if (action != null) {
//                mActions.add(action);
//            }
//            return this;
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder clearActions() {
//            mActions.clear();
//            return this;
//        }
//
...
//         * be retrieved using {@link CustomNotificationCompact#getInvisibleActions(Notification)}.
//         *
//         * @param icon Resource ID of a drawable that represents the action.
//         * @param title Text describing the action.
//         * @param intent {@link android.app.PendingIntent} to be fired when the action is invoked.
...
//        @RequiresApi(21)
//        @NonNull
//        public CustomNotificationCompact.Builder addInvisibleAction(int icon, @Nullable CharSequence title,
//                                                                               @Nullable PendingIntent intent) {
//            mInvisibleActions.add(new CustomNotificationCompact.Action(icon, title, intent));
//            return this;
//        }
//
//        /**
...
//        @RequiresApi(21)
//        public @NonNull
//        CustomNotificationCompact.Builder addInvisibleAction(@Nullable CustomNotificationCompact.Action action) {
//            if (action != null) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder clearInvisibleActions() {
...
//            Bundle carExtenderBundle = mExtras.getBundle(CustomNotificationCompact.CarExtender.EXTRA_CAR_EXTENDER);
//            if (carExtenderBundle != null) {
//                carExtenderBundle = new Bundle(carExtenderBundle);
//                carExtenderBundle.remove(CustomNotificationCompact.CarExtender.EXTRA_INVISIBLE_ACTIONS);
//                mExtras.putBundle(CustomNotificationCompact.CarExtender.EXTRA_CAR_EXTENDER, carExtenderBundle);
//            }
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setStyle(@Nullable CustomNotificationCompact.Style style) {
//            if (mStyle != style) {
//                mStyle = style;
//                if (mStyle != null) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setColor(@ColorInt int argb) {
//            mColor = argb;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setVisibility(@CustomNotificationCompact.NotificationVisibility int visibility) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setPublicVersion(@Nullable Notification n) {
//            mPublicVersion = n;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setCustomContentView(@Nullable RemoteViews contentView) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setCustomBigContentView(@Nullable RemoteViews contentView) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setCustomHeadsUpContentView(@Nullable RemoteViews contentView) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setChannelId(@NonNull String channelId) {
//            mChannelId = channelId;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setTimeoutAfter(long durationMs) {
//            mTimeout = durationMs;
//            return this;
//        }
//
//        /**
//         * From Android 11, messaging notifications (those that use {@link CustomNotificationCompact.MessagingStyle}) that
...
//         * notification.
//         * <p>
//         * If this notification has {@link CustomNotificationCompact.BubbleMetadata} attached that was created with
...
//         *
//         * @see CustomNotificationCompact.BubbleMetadata.Builder#Builder()
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setShortcutId(@Nullable String shortcutId) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setShortcutInfo(@Nullable final ShortcutInfoCompat shortcutInfo) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setLocusId(@Nullable final LocusIdCompat locusId) {
//            mLocusId = locusId;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setBadgeIconType(@CustomNotificationCompact.BadgeIconType int icon) {
//            mBadgeIcon = icon;
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setGroupAlertBehavior(@CustomNotificationCompact.GroupAlertBehavior int groupAlertBehavior) {
...
//         * {@link CustomNotificationCompact#FOREGROUND_SERVICE_IMMEDIATE FOREGROUND_SERVICE_IMMEDIATE}
//         * to this method in order to guarantee that visibility is never deferred.  Pass
//         * {@link CustomNotificationCompact#FOREGROUND_SERVICE_DEFERRED FOREGROUND_SERVICE_DEFERRED}
...
//        @NonNull
//        public CustomNotificationCompact.Builder setForegroundServiceBehavior(@CustomNotificationCompact.ServiceNotificationBehavior int behavior) {
//            mFgsDeferBehavior = behavior;
//            return this;
//        }
//
//        /**
//         * Sets the {@link CustomNotificationCompact.BubbleMetadata} that will be used to display app content in a floating
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setBubbleMetadata(@Nullable CustomNotificationCompact.BubbleMetadata data) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder extend(@NonNull CustomNotificationCompact.Extender extender) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.Builder setAllowSystemGeneratedContextualActions(boolean allowed) {
...
//
//        /**
//         * @return the {@link CustomNotificationCompact.BubbleMetadata} of the notification
//         *
//         * @hide
//         */
//        @RestrictTo(LIBRARY_GROUP_PREFIX)
//        public @Nullable
//        CustomNotificationCompact.BubbleMetadata getBubbleMetadata() {
...
//         */
//        @RestrictTo(LIBRARY_GROUP_PREFIX)
//        protected CustomNotificationCompact.Builder mBuilder;
...
//         */
//        public void setBuilder(@Nullable CustomNotificationCompact.Builder builder) {
//            if (mBuilder != builder) {
//                mBuilder = builder;
//                if (mBuilder != null) {
...
//         * {@link CustomNotificationCompact.Builder#build()} process, after <code>apply()</code> has been called.  This means
...
//        @RestrictTo(LIBRARY_GROUP_PREFIX)
//        @Nullable
//        public static CustomNotificationCompact.Style extractStyleFromNotification(@NonNull Notification notification) {
//            Bundle extras = CustomNotificationCompact.getExtras(notification);
//            if (extras == null) {
//                return null;
//            }
...
//
//        @Nullable
//        private static CustomNotificationCompact.Style constructCompatStyleByPlatformName(
...
//
//        @Nullable
//        static CustomNotificationCompact.Style constructCompatStyleByName(@Nullable String templateClass) {
//            if (templateClass != null) {
//                switch (templateClass) {
//                    case CustomNotificationCompact.BigTextStyle.TEMPLATE_CLASS_NAME:
//                        return new CustomNotificationCompact.BigTextStyle();
//                    case CustomNotificationCompact.BigPictureStyle.TEMPLATE_CLASS_NAME:
//                        return new CustomNotificationCompact.BigPictureStyle();
//                    case CustomNotificationCompact.InboxStyle.TEMPLATE_CLASS_NAME:
//                        return new CustomNotificationCompact.InboxStyle();
//                    case CustomNotificationCompact.DecoratedCustomViewStyle.TEMPLATE_CLASS_NAME:
//                        return new CustomNotificationCompact.DecoratedCustomViewStyle();
//                    case CustomNotificationCompact.MessagingStyle.TEMPLATE_CLASS_NAME:
//                        return new CustomNotificationCompact.MessagingStyle();
//                }
//            }
//            return null;
...
//
//        @Nullable
//        static CustomNotificationCompact.Style constructCompatStyleForBundle(@NonNull Bundle extras) {
//            // If the compat template name provided in the bundle can be resolved to a class, use
//            // that style class.
//            CustomNotificationCompact.Style style = constructCompatStyleByName(extras.getString(EXTRA_COMPAT_TEMPLATE));
//            if (style != null) {
//                return style;
//            }
...
//
//        @Nullable
//        static CustomNotificationCompact.Style constructStyleForExtras(@NonNull Bundle extras) {
//            final CustomNotificationCompact.Style style = constructCompatStyleForBundle(extras);
//            if (style == null) {
//                return null;
//            }
//            try {
...
//
//            boolean minPriority = mBuilder.getPriority() < CustomNotificationCompact.PRIORITY_LOW;
...
//                    color == CustomNotificationCompact.COLOR_DEFAULT ? 0 : color, size);
...
//     */
//    public static class BigPictureStyle extends CustomNotificationCompact.Style {
//
//        private static final String TEMPLATE_CLASS_NAME =
//                "CustomNotificationCompact$BigPictureStyle";
//
...
//        }
//
//        public BigPictureStyle(@Nullable CustomNotificationCompact.Builder builder) {
//            setBuilder(builder);
//        }
//
//        /**
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigPictureStyle setBigContentTitle(@Nullable CharSequence title) {
//            mBigContentTitle = CustomNotificationCompact.Builder.limitCharSequenceLength(title);
//            return this;
//        }
//
//        /**
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigPictureStyle setSummaryText(@Nullable CharSequence cs) {
//            mSummaryText = CustomNotificationCompact.Builder.limitCharSequenceLength(cs);
//            mSummaryTextSet = true;
//            return this;
//        }
//
...
//        @RequiresApi(31)
//        @NonNull
//        public CustomNotificationCompact.BigPictureStyle setContentDescription(
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigPictureStyle bigPicture(@Nullable Bitmap b) {
//            mPicture = b;
//            return this;
//        }
//
...
//         * shown in place of the {@link CustomNotificationCompact.Builder#setLargeIcon(Bitmap) large icon} in the collapsed
//         * state of this notification.
//         */
//        @RequiresApi(31)
//        @NonNull
//        public CustomNotificationCompact.BigPictureStyle showBigPictureWhenCollapsed(boolean show) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigPictureStyle bigLargeIcon(@Nullable Bitmap b) {
...
//                        CustomNotificationCompact.BigPictureStyle.Api16Impl.setBigLargeIcon(style, null);
//                    } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                        Context context = null;
//                        if (builder instanceof NotificationCompatBuilder) {
//                            context = ((NotificationCompatBuilder) builder).getContext();
//                        }
//                        CustomNotificationCompact.BigPictureStyle.Api23Impl.setBigLargeIcon(style, mBigLargeIcon.toIcon(context));
//                    } else if (mBigLargeIcon.getType() == IconCompat.TYPE_BITMAP) {
//                        // Before M, only the Bitmap setter existed
//                        CustomNotificationCompact.BigPictureStyle.Api16Impl.setBigLargeIcon(style, mBigLargeIcon.getBitmap());
//                    } else {
...
//                }
//                if (mSummaryTextSet) {
//                    CustomNotificationCompact.BigPictureStyle.Api16Impl.setSummaryText(style, mSummaryText);
//                }
//                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
//                    CustomNotificationCompact.BigPictureStyle.Api31Impl.showBigPictureWhenCollapsed(style, mShowBigPictureWhenCollapsed);
//                    CustomNotificationCompact.BigPictureStyle.Api31Impl.setContentDescription(style, mPictureContentDescription);
//                }
//            }
//        }
//
...
//     * @see Notification#bigContentView
//     */
//    public static class BigTextStyle extends CustomNotificationCompact.Style {
//
//        private static final String TEMPLATE_CLASS_NAME =
//                "CustomNotificationCompact$BigTextStyle";
//
...
//        }
//
//        public BigTextStyle(@Nullable CustomNotificationCompact.Builder builder) {
//            setBuilder(builder);
//        }
//
//        /**
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigTextStyle setBigContentTitle(@Nullable CharSequence title) {
//            mBigContentTitle = CustomNotificationCompact.Builder.limitCharSequenceLength(title);
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigTextStyle setSummaryText(@Nullable CharSequence cs) {
//            mSummaryText = CustomNotificationCompact.Builder.limitCharSequenceLength(cs);
//            mSummaryTextSet = true;
//            return this;
//        }
...
//         */
//        public @NonNull
//        CustomNotificationCompact.BigTextStyle bigText(@Nullable CharSequence cs) {
//            mBigText = CustomNotificationCompact.Builder.limitCharSequenceLength(cs);
//            return this;
//        }
//
//        /**
...
//     *
//     * <br>
//     * Use {@link CustomNotificationCompact.MessagingStyle#setConversationTitle(CharSequence)} to set a conversation title for
...
//     * </pre>
//     */
//    public static class MessagingStyle extends CustomNotificationCompact.Style {
//
//        private static final String TEMPLATE_CLASS_NAME =
//                "CustomNotificationCompact$MessagingStyle";
//
//        /**
...
//
//        private final List<CustomNotificationCompact.MessagingStyle.Message> mMessages = new ArrayList<>();
//        private final List<CustomNotificationCompact.MessagingStyle.Message> mHistoricMessages = new ArrayList<>();
//        private Person mUser;
//        private @Nullable CharSequence mConversationTitle;
//        private @Nullable Boolean mIsGroupConversation;
//
//        /** Package private empty constructor for {@link CustomNotificationCompact.Style#restoreFromCompatExtras(Bundle)}. */
//        MessagingStyle() {}
//
//        /**
...
//         * {@link #addMessage(CustomNotificationCompact.MessagingStyle.Message)}
...
//
//        /**
//         * Creates a new {@link CustomNotificationCompact.MessagingStyle} object. Note that {@link Person} must have a
//         * non-empty name.
//         *
...
//         */
//        public @NonNull
//        CustomNotificationCompact.MessagingStyle setConversationTitle(
...
//         * {@link CustomNotificationCompact.MessagingStyle.Message} in {@link #addMessage(CustomNotificationCompact.MessagingStyle.Message)}
...
//         *
//         * @see CustomNotificationCompact.MessagingStyle.Message#Message(CharSequence, long, CharSequence)
//         *
//         * @return this object for method chaining
//         *
...
//        @Deprecated
//        @NonNull
//        public CustomNotificationCompact.MessagingStyle addMessage(@Nullable CharSequence text, long timestamp,
//                                                                              @Nullable CharSequence sender) {
//            mMessages.add(
//                    new CustomNotificationCompact.MessagingStyle.Message(text, timestamp, new Person.Builder().setName(sender).build()));
...
//         * {@link #addMessage(CustomNotificationCompact.MessagingStyle.Message)}.
//         *
//         * @see CustomNotificationCompact.MessagingStyle.Message#Message(CharSequence, long, Person)
//         *
//         * @return this for method chaining
//         */
//        public @NonNull
//        CustomNotificationCompact.MessagingStyle addMessage(@Nullable CharSequence text, long timestamp,
//                                                                       @Nullable Person person) {
//            addMessage(new CustomNotificationCompact.MessagingStyle.Message(text, timestamp, person));
//            return this;
//        }
//
//        /**
//         * Adds a {@link CustomNotificationCompact.MessagingStyle.Message} for display in this notification.
//         *
//         * @param message The {@link CustomNotificationCompact.MessagingStyle.Message} to be displayed
//         *
//         * @return this object for method chaining
//         */
//        public @NonNull
//        CustomNotificationCompact.MessagingStyle addMessage(@Nullable CustomNotificationCompact.MessagingStyle.Message message) {
//            if (message != null) {
...
//
//        /**
//         * Adds a {@link CustomNotificationCompact.MessagingStyle.Message} for historic context in this notification.
//         *
...
//         * the newest last.
//         *
//         * @param message The historic {@link CustomNotificationCompact.MessagingStyle.Message} to be added
//         * @return this object for method chaining
//         */
//        public @NonNull
//        CustomNotificationCompact.MessagingStyle addHistoricMessage(@Nullable CustomNotificationCompact.MessagingStyle.Message message) {
//            if (message != null) {
...
//         */
//        public @NonNull List<CustomNotificationCompact.MessagingStyle.Message> getMessages() {
//            return mMessages;
//        }
//
//        /**
...
//         */
//        public @NonNull List<CustomNotificationCompact.MessagingStyle.Message> getHistoricMessages() {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.MessagingStyle setGroupConversation(boolean isGroupConversation) {
...
//         * {@code false}.
//         *
//         * <p> If the application that generated this {@link CustomNotificationCompact.MessagingStyle} targets an SDK version
...
//
//        /**
//         * Retrieves a {@link CustomNotificationCompact.MessagingStyle} from a {@link Notification}, enabling an application
//         * that has set a {@link CustomNotificationCompact.MessagingStyle} using {@link CustomNotificationCompact} or
//         * {@link android.app.Notification.Builder} to send messaging information to another
//         * application using {@link CustomNotificationCompact}, regardless of the API level of the system.
//         *
//         * @return {@code null} if there is no {@link CustomNotificationCompact.MessagingStyle} set, or if the SDK version is
//         * &lt; {@code 16} (JellyBean).
//         */
//        @Nullable
//        public static CustomNotificationCompact.MessagingStyle extractMessagingStyleFromNotification(
//                @NonNull Notification notification) {
//            CustomNotificationCompact.Style style = CustomNotificationCompact.Style.extractStyleFromNotification(notification);
//            if (style instanceof CustomNotificationCompact.MessagingStyle) {
//                return (CustomNotificationCompact.MessagingStyle) style;
//            }
//            return null;
//        }
//
...
//                }
//
//                for (CustomNotificationCompact.MessagingStyle.Message message : mMessages) {
//                    frameworkStyle.addMessage(message.toAndroidMessage());
//                }
//
//                if (Build.VERSION.SDK_INT >= 26) {
//                    for (CustomNotificationCompact.MessagingStyle.Message historicMessage : mHistoricMessages) {
...
//            } else {
//                CustomNotificationCompact.MessagingStyle.Message latestIncomingMessage = findLatestIncomingMessage();
//                // Set the title
...
//                        CustomNotificationCompact.MessagingStyle.Message message = mMessages.get(i);
//                        CharSequence line;
...
//
//        @Nullable
//        private CustomNotificationCompact.MessagingStyle.Message findLatestIncomingMessage() {
//            for (int i = mMessages.size() - 1; i >= 0; i--) {
//                CustomNotificationCompact.MessagingStyle.Message message = mMessages.get(i);
...
//        }
//
//        private CharSequence makeMessageLine(@NonNull CustomNotificationCompact.MessagingStyle.Message message) {
...
//                color = afterLollipop && mBuilder.getColor() != CustomNotificationCompact.COLOR_DEFAULT
//                        ? mBuilder.getColor()
//                        : color;
//            }
...
//                        CustomNotificationCompact.MessagingStyle.Message.getBundleArrayForMessages(mMessages));
//            }
//            if (!mHistoricMessages.isEmpty()) {
//                extras.putParcelableArray(EXTRA_HISTORIC_MESSAGES,
//                        CustomNotificationCompact.MessagingStyle.Message.getBundleArrayForMessages(mHistoricMessages));
//            }
...
//            if (messages != null) {
//                mMessages.addAll(CustomNotificationCompact.MessagingStyle.Message.getMessagesFromBundleArray(messages));
//            }
//            Parcelable[] historicMessages = extras.getParcelableArray(EXTRA_HISTORIC_MESSAGES);
//            if (historicMessages != null) {
//                mHistoricMessages.addAll(CustomNotificationCompact.MessagingStyle.Message.getMessagesFromBundleArray(historicMessages));
//            }
...
//
//            /**
//             * Creates a new {@link CustomNotificationCompact.MessagingStyle.Message} with the given text, timestamp, and sender.
//             *
//             * @param text A {@link CharSequence} to be displayed as the message content
//             * @param timestamp Time at which the message arrived in ms since Unix epoch
...
//             * {@link CustomNotificationCompact.MessagingStyle#getUserDisplayName()}. A {@link Person}'s key should be
//             * consistent during re-posts of the notification.
//             */
...
//             * @param sender A {@link CharSequence} to be used for displaying the name of the
//             * sender. Should be <code>null</code> for messages by the current user, in which case
//             * the platform will insert {@link CustomNotificationCompact.MessagingStyle#getUserDisplayName()}.
//             * Should be unique amongst all individuals in the conversation, and should be
//             * consistent during re-posts of the notification.
//             *
...
//             */
//            public @NonNull
//            CustomNotificationCompact.MessagingStyle.Message setData(@Nullable String dataMimeType, @Nullable Uri dataUri) {
...
//
//            @NonNull
//            static Bundle[] getBundleArrayForMessages(@NonNull List<CustomNotificationCompact.MessagingStyle.Message> messages) {
...
//
//            @NonNull
//            static List<CustomNotificationCompact.MessagingStyle.Message> getMessagesFromBundleArray(@NonNull Parcelable[] bundles) {
//                List<CustomNotificationCompact.MessagingStyle.Message> messages = new ArrayList<>(bundles.length);
//                for (int i = 0; i < bundles.length; i++) {
//                    if (bundles[i] instanceof Bundle) {
//                        CustomNotificationCompact.MessagingStyle.Message message = getMessageFromBundle((Bundle)bundles[i]);
//                        if (message != null) {
...
//            @Nullable
//            @SuppressWarnings("deprecation")
//            static CustomNotificationCompact.MessagingStyle.Message getMessageFromBundle(@NonNull Bundle bundle) {
//                try {
...
//                    }
//
//                    CustomNotificationCompact.MessagingStyle.Message message = new CustomNotificationCompact.MessagingStyle.Message(
...
//
//            /**
//             * Converts this compat {@link CustomNotificationCompact.MessagingStyle.Message} to the base Android framework
...
//     * @see Notification#bigContentView
//     */
//    public static class InboxStyle extends CustomNotificationCompact.Style {
//
//        private static final String TEMPLATE_CLASS_NAME =
//                "CustomNotificationCompact$InboxStyle";
//
...
//        }
//
//        public InboxStyle(@Nullable CustomNotificationCompact.Builder builder) {
//            setBuilder(builder);
//        }
//
//        /**
...
//         */
//        public @NonNull
//        CustomNotificationCompact.InboxStyle setBigContentTitle(@Nullable CharSequence title) {
//            mBigContentTitle = CustomNotificationCompact.Builder.limitCharSequenceLength(title);
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.InboxStyle setSummaryText(@Nullable CharSequence cs) {
//            mSummaryText = CustomNotificationCompact.Builder.limitCharSequenceLength(cs);
//            mSummaryTextSet = true;
//            return this;
//        }
...
//         */
//        public @NonNull
//        CustomNotificationCompact.InboxStyle addLine(@Nullable CharSequence cs) {
//            if (cs != null) {
//                mTexts.add(CustomNotificationCompact.Builder.limitCharSequenceLength(cs));
//            }
//            return this;
//        }
//
...
//     *
//     * <p>Use {@link CustomNotificationCompact.Builder#setCustomContentView(RemoteViews)},
//     * {@link CustomNotificationCompact.Builder#setCustomBigContentView(RemoteViews)} and
//     * {@link CustomNotificationCompact.Builder#setCustomHeadsUpContentView(RemoteViews)} to set the
//     * corresponding custom views to display.
//     *
//     * <p>To use this style with your Notification, feed it to
//     * {@link CustomNotificationCompact.Builder#setStyle(CustomNotificationCompact.Style)} like so:
//     * <pre class="prettyprint">
...
//     */
//    public static class DecoratedCustomViewStyle extends CustomNotificationCompact.Style {
//
//        private static final String TEMPLATE_CLASS_NAME =
//                "CustomNotificationCompact$DecoratedCustomViewStyle";
//
...
//            List<CustomNotificationCompact.Action> nonContextualActions =
...
//        }
//
//        private static List<CustomNotificationCompact.Action> getNonContextualActions(
//                List<CustomNotificationCompact.Action> actions) {
//            if (actions == null) return null;
//            List<CustomNotificationCompact.Action> nonContextualActions = new ArrayList<>();
//            for (CustomNotificationCompact.Action action : actions) {
...
//        }
//
//        private RemoteViews generateActionButton(CustomNotificationCompact.Action action) {
...
//     * <p>
//     * Apps should use {@link CustomNotificationCompact.Builder#addAction(int, CharSequence, PendingIntent)}
//     * or {@link CustomNotificationCompact.Builder#addAction(CustomNotificationCompact.Action)}
//     * to attach actions.
//     */
//    public static class Action {
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: No semantic action defined.
//         */
//        public static final int SEMANTIC_ACTION_NONE = 0;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Reply to a conversation, chat, group, or wherever replies
//         * may be appropriate.
//         */
//        public static final int SEMANTIC_ACTION_REPLY = 1;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Mark content as read.
//         */
//        public static final int SEMANTIC_ACTION_MARK_AS_READ = 2;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Mark content as unread.
//         */
//        public static final int SEMANTIC_ACTION_MARK_AS_UNREAD = 3;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Delete the content associated with the notification. This
//         * could mean deleting an email, message, etc.
//         */
//        public static final int SEMANTIC_ACTION_DELETE = 4;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Archive the content associated with the notification. This
//         * could mean archiving an email, message, etc.
//         */
//        public static final int SEMANTIC_ACTION_ARCHIVE = 5;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Mute the content associated with the notification. This could
//         * mean silencing a conversation or currently playing media.
//         */
//        public static final int SEMANTIC_ACTION_MUTE = 6;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Unmute the content associated with the notification. This could
//         * mean un-silencing a conversation or currently playing media.
//         */
//        public static final int SEMANTIC_ACTION_UNMUTE = 7;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Mark content with a thumbs up.
//         */
//        public static final int SEMANTIC_ACTION_THUMBS_UP = 8;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Mark content with a thumbs down.
//         */
//        public static final int SEMANTIC_ACTION_THUMBS_DOWN = 9;
//
//        /**
//         * {@link CustomNotificationCompact.Action.SemanticAction}: Call a contact, group, etc.
//         */
...
//         * support non-text-based {@link RemoteInput}s. See {@link CustomNotificationCompact.Action.Builder#build}.
//         *
...
//
//        private final @CustomNotificationCompact.Action.SemanticAction
//        int mSemanticAction;
...
//               boolean allowGeneratedReplies, @CustomNotificationCompact.Action.SemanticAction int semanticAction,
...
//            }
//            this.title = CustomNotificationCompact.Builder.limitCharSequenceLength(title);
...
//         * {@link CustomNotificationCompact.Action}
//         */
...
//
//        /**
//         * Returns the {@link CustomNotificationCompact.Action.SemanticAction} associated with this {@link CustomNotificationCompact.Action}. A
//         * {@link CustomNotificationCompact.Action.SemanticAction} denotes what an {@link CustomNotificationCompact.Action}'s {@link PendingIntent} will do
//         * (eg. reply, mark as read, delete, etc).
//         *
//         * @see CustomNotificationCompact.Action.SemanticAction
//         */
//        public @CustomNotificationCompact.Action.SemanticAction
...
//
//        /**
//         * Return whether or not triggering this {@link CustomNotificationCompact.Action}'s {@link PendingIntent} will open a
//         * user interface.
//         */
...
//
//        /**
//         * Builder class for {@link CustomNotificationCompact.Action} objects.
//         */
...
//            private @CustomNotificationCompact.Action.SemanticAction
//            int mSemanticAction;
...
//
//            /**
//             * Creates a {@link CustomNotificationCompact.Action.Builder} from an {@link android.app.Notification.Action}.
//             *
//             * @hide
//             */
//            @RestrictTo(LIBRARY_GROUP_PREFIX)
//            @RequiresApi(19)
//            @NonNull
//            public static CustomNotificationCompact.Action.Builder fromAndroidAction(@NonNull Notification.Action action) {
//                final CustomNotificationCompact.Action.Builder builder;
//                if (Build.VERSION.SDK_INT >= 23 && action.getIcon() != null) {
//                    IconCompat iconCompat = IconCompat.createFromIcon(action.getIcon());
//                    builder = new CustomNotificationCompact.Action.Builder(iconCompat, action.title,
//                            action.actionIntent);
//                } else {
//                    builder = new CustomNotificationCompact.Action.Builder(action.icon, action.title,
//                            action.actionIntent);
//                }
...
//
//            /**
//             * Construct a new builder for {@link CustomNotificationCompact.Action} object.
//             *
...
//
//            /**
//             * Construct a new builder for {@link CustomNotificationCompact.Action} object using the fields from an
//             * {@link CustomNotificationCompact.Action}.
//             * @param action the action to read fields from.
//             */
//            public Builder(@NonNull CustomNotificationCompact.Action action) {
...
//                            @CustomNotificationCompact.Action.SemanticAction int semanticAction, boolean showsUserInterface,
//                            boolean isContextual, boolean authRequired) {
//                mIcon = icon;
//                mTitle = CustomNotificationCompact.Builder.limitCharSequenceLength(title);
//                mIntent = intent;
//                mExtras = extras;
...
//             * <p>Values within the Bundle will replace existing extras values in this Builder.
//             *
//             * @see CustomNotificationCompact.Action#getExtras
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder addExtras(@Nullable Bundle extras) {
//                if (extras != null) {
//                    mExtras.putAll(extras);
//                }
//                return this;
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder addRemoteInput(@Nullable RemoteInput remoteInput) {
...
//             * {@link RemoteInput#getChoices()}. If the {@link CustomNotificationCompact.Action} doesn't have a
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder setAllowGeneratedReplies(boolean allowGeneratedReplies) {
//                mAllowGeneratedReplies = allowGeneratedReplies;
//                return this;
//            }
//
//            /**
//             * Sets the {@link CustomNotificationCompact.Action.SemanticAction} for this {@link CustomNotificationCompact.Action}. A {@link CustomNotificationCompact.Action.SemanticAction}
//             * denotes what an {@link CustomNotificationCompact.Action}'s {@link PendingIntent} will do (eg. reply, mark
//             * as read, delete, etc).
//             * @param semanticAction a {@link CustomNotificationCompact.Action.SemanticAction} defined within {@link CustomNotificationCompact.Action} with
//             * {@code SEMANTIC_ACTION_} prefixes
//             * @return this object for method chaining
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder setSemanticAction(@CustomNotificationCompact.Action.SemanticAction int semanticAction) {
//                mSemanticAction = semanticAction;
//                return this;
//            }
//
//            /**
//             * Sets whether this {@link CustomNotificationCompact.Action} is a contextual action, i.e. whether the action is
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder setContextual(boolean isContextual) {
//                mIsContextual = isContextual;
//                return this;
//            }
//
...
//             */
//            @NonNull
//            public CustomNotificationCompact.Action.Builder setAuthenticationRequired(boolean authenticationRequired) {
//                mAuthenticationRequired = authenticationRequired;
//                return this;
//            }
//
//            /**
//             * Set whether or not this {@link CustomNotificationCompact.Action}'s {@link PendingIntent} will open a user
//             * interface.
//             * @param showsUserInterface {@code true} if this {@link CustomNotificationCompact.Action}'s {@link PendingIntent}
//             * will open a user interface, otherwise {@code false}
//             * @return this object for method chaining
//             * The default value is {@code true}
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder setShowsUserInterface(boolean showsUserInterface) {
//                mShowsUserInterface = showsUserInterface;
//                return this;
//            }
//
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.Builder extend(@NonNull CustomNotificationCompact.Action.Extender extender) {
//                extender.extend(this);
//                return this;
//            }
//
...
//
//            /**
//             * Combine all of the options that have been set and return a new {@link CustomNotificationCompact.Action}
//             * object.
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action build() {
...
//                return new CustomNotificationCompact.Action(mIcon, mTitle, mIntent, mExtras, textInputsArr,
...
//
//        /**
//         * Extender interface for use with {@link CustomNotificationCompact.Action.Builder#extend}. Extenders may be used to add
...
//             */
//            @NonNull
//            CustomNotificationCompact.Action.Builder extend(@NonNull CustomNotificationCompact.Action.Builder builder);
//        }
//
//        /**
//         * Wearable extender for notification actions. To add extensions to an action,
//         * create a new {@link CustomNotificationCompact.Action.WearableExtender} object using
//         * the {@code WearableExtender()} constructor and apply it to a
//         * {@link CustomNotificationCompact.Action.Builder} using
//         * {@link CustomNotificationCompact.Action.Builder#extend}.
//         *
//         * <pre class="prettyprint">
...
//         *         .build();</pre>
//         */
//        public static final class WearableExtender implements CustomNotificationCompact.Action.Extender {
...
//
//            /**
//             * Create a {@link CustomNotificationCompact.Action.WearableExtender} with default
//             * options.
//             */
...
//
//            /**
//             * Create a {@link CustomNotificationCompact.Action.WearableExtender} by reading
//             * wearable options present in an existing notification action.
//             * @param action the notification action to inspect.
//             */
//            public WearableExtender(@NonNull CustomNotificationCompact.Action action) {
...
//             * typically called by the {@link CustomNotificationCompact.Action.Builder#extend}
//             * method of {@link CustomNotificationCompact.Action.Builder}.
//             */
//            @Override
//            public @NonNull CustomNotificationCompact.Action.Builder extend(@NonNull CustomNotificationCompact.Action.Builder builder) {
...
//            @Override
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender clone() {
//                CustomNotificationCompact.Action.WearableExtender that = new CustomNotificationCompact.Action.WearableExtender();
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender setAvailableOffline(boolean availableOffline) {
...
//            @Deprecated
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender setInProgressLabel(@Nullable CharSequence label) {
...
//            @Deprecated
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender setConfirmLabel(@Nullable CharSequence label) {
//                mConfirmLabel = label;
//                return this;
//            }
//
...
//            @Deprecated
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender setCancelLabel(@Nullable CharSequence label) {
//                mCancelLabel = label;
//                return this;
//            }
//
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender setHintLaunchesActivity(
...
//             */
//            public @NonNull
//            CustomNotificationCompact.Action.WearableExtender setHintDisplayActionInline(
...
//
//        /**
//         * Provides meaning to an {@link CustomNotificationCompact.Action} that hints at what the associated
//         * {@link PendingIntent} will do. For example, an {@link CustomNotificationCompact.Action} with a
//         * {@link PendingIntent} that replies to a text message notification may have the
//         * {@link #SEMANTIC_ACTION_REPLY} {@link CustomNotificationCompact.Action.SemanticAction} set within it.
//         */
//        @IntDef({
//                SEMANTIC_ACTION_NONE,
...
//
//    /**
//     * Extender interface for use with {@link CustomNotificationCompact.Builder#extend}. Extenders may be used to add
...
//         */
//        @NonNull
//        CustomNotificationCompact.Builder extend(@NonNull CustomNotificationCompact.Builder builder);
//    }
//
//    /**
...
//     * <ol>
//     *   <li>Create a {@link CustomNotificationCompact.Builder}, setting any desired
//     *   properties.</li>
//     *   <li>Create a {@link CustomNotificationCompact.WearableExtender}.</li>
//     *   <li>Set wearable-specific properties using the
//     *   {@code add} and {@code set} methods of {@link CustomNotificationCompact.WearableExtender}.</li>
//     *   <li>Call {@link CustomNotificationCompact.Builder#extend} to apply the extensions to a
//     *   notification.</li>
...
//     */
//    public static final class WearableExtender implements CustomNotificationCompact.Extender {
//        /**
...
//
//        private ArrayList<CustomNotificationCompact.Action> mActions = new ArrayList<>();
//        private int mFlags = DEFAULT_FLAGS;
...
//
//        /**
//         * Create a {@link CustomNotificationCompact.WearableExtender} with default
//         * options.
//         */
//        public WearableExtender() {
//        }
...
//                    CustomNotificationCompact.Action[] actions = new CustomNotificationCompact.Action[parcelables.size()];
//                    for (int i = 0; i < actions.length; i++) {
//                        if (Build.VERSION.SDK_INT >= 20) {
//                            actions[i] = CustomNotificationCompact.getActionCompatFromAction(
...
//                        }
//                    }
//                    Collections.addAll(mActions, (CustomNotificationCompact.Action[]) actions);
//                }
//
//                mFlags = wearableBundle.getInt(KEY_FLAGS, DEFAULT_FLAGS);
...
//         * called by the {@link CustomNotificationCompact.Builder#extend} method of
//         * {@link CustomNotificationCompact.Builder}.
//         */
//        @SuppressWarnings("deprecation")
//        @Override
//        @NonNull
//        public CustomNotificationCompact.Builder extend(@NonNull CustomNotificationCompact.Builder builder) {
//            Bundle wearableBundle = new Bundle();
//
//            if (!mActions.isEmpty()) {
//                if (Build.VERSION.SDK_INT >= 16) {
//                    ArrayList<Parcelable> parcelables = new ArrayList<>(mActions.size());
//                    for (CustomNotificationCompact.Action action : mActions) {
//                        if (Build.VERSION.SDK_INT >= 20) {
//                            parcelables.add(
//                                    CustomNotificationCompact.WearableExtender.getActionFromActionCompat(action));
//                        } else if (Build.VERSION.SDK_INT >= 16) {
...
//
//        @RequiresApi(20)
//        private static Notification.Action getActionFromActionCompat(CustomNotificationCompact.Action actionCompat) {
...
//        @Override
//        @NonNull
//        public CustomNotificationCompact.WearableExtender clone() {
//            CustomNotificationCompact.WearableExtender that = new CustomNotificationCompact.WearableExtender();
...
//         * using {@link CustomNotificationCompact.Builder#addAction}. This allows for customization
//         * of which actions display on different devices.
//         *
//         * @param action the action to add to this notification
//         * @return this object for method chaining
//         * @see CustomNotificationCompact.Action
//         */
//        public @NonNull
//        CustomNotificationCompact.WearableExtender addAction(@NonNull CustomNotificationCompact.Action action) {
//            mActions.add(action);
//            return this;
//        }
//
...
//         */
//        public @NonNull
//        CustomNotificationCompact.WearableExtender addActions(@NonNull List<CustomNotificationCompact.Action> actions) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.WearableExtender clearActions() {
//            mActions.clear();
//            return this;
//        }
//
...
//         */
//        public @NonNull List<CustomNotificationCompact.Action> getActions() {
//            return mActions;
//        }
//
//        /**
...
//         * @return this object for method chaining
//         * @see CustomNotificationCompact.WearableExtender#getDisplayIntent
//         * @deprecated Display intents are no longer supported.
//         */
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setDisplayIntent(@Nullable PendingIntent intent) {
...
//         * @return this object for method chaining
//         * @see CustomNotificationCompact.WearableExtender#getPages
//         * @deprecated Multiple content pages are no longer supported.
//         */
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender addPage(@NonNull Notification page) {
//            mPages.add(page);
//            return this;
//        }
//
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender addPages(@NonNull List<Notification> pages) {
//            mPages.addAll(pages);
//            return this;
//        }
//
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender clearPages() {
//            mPages.clear();
//            return this;
//        }
//
...
//         * Contrary to the {@link CustomNotificationCompact.BigPictureStyle}, this background
//         * will work with any notification style.
//         *
//         * @param background the background bitmap
//         * @return this object for method chaining
//         * @see CustomNotificationCompact.WearableExtender#getBackground
//         * @deprecated Background images are no longer supported.
//         */
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setBackground(@Nullable Bitmap background) {
...
//         * @see CustomNotificationCompact.WearableExtender#setBackground
//         * @deprecated Background images are no longer supported.
//         */
//        @Deprecated
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setContentIcon(int icon) {
//            mContentIcon = icon;
//            return this;
//        }
//
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setContentIconGravity(int contentIconGravity) {
...
//         */
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setContentAction(int actionIndex) {
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setGravity(int gravity) {
//            mGravity = gravity;
//            return this;
//        }
//
...
//         * presets found in {@link CustomNotificationCompact.WearableExtender}, e.g.
//         * {@link #SIZE_LARGE}.
//         * <p>Some custom size presets are only applicable for custom display notifications created
//         * using {@link CustomNotificationCompact.WearableExtender#setDisplayIntent}. Check the
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setCustomSizePreset(int sizePreset) {
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setCustomContentHeight(int height) {
...
//
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setStartScrollBottom(boolean startScrollBottom) {
...
//
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setContentIntentAvailableOffline(
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setHintHideIcon(boolean hintHideIcon) {
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setHintShowBackgroundOnly(boolean hintShowBackgroundOnly) {
...
//        @Deprecated
//        @NonNull
//        public CustomNotificationCompact.WearableExtender setHintAvoidBackgroundClipping(
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setHintScreenTimeout(int timeout) {
...
//        @Deprecated
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setHintAmbientBigPicture(boolean hintAmbientBigPicture) {
...
//
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setHintContentIntentLaunchesActivity(
...
//
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setDismissalId(@Nullable String dismissalId) {
...
//
//        public @NonNull
//        CustomNotificationCompact.WearableExtender setBridgeTag(@Nullable String bridgeTag) {
...
//    }
//
//    public static final class CarExtender implements CustomNotificationCompact.Extender {
//        /** @hide **/
//        @RestrictTo(LIBRARY_GROUP_PREFIX)
...
//        private CustomNotificationCompact.CarExtender.UnreadConversation mUnreadConversation;
//        private int mColor = CustomNotificationCompact.COLOR_DEFAULT;
//
//        /**
//         * Create a {@link CustomNotificationCompact.CarExtender} with default options.
//         */
//        public CarExtender() {
//        }
//
//        /**
//         * Create a {@link CustomNotificationCompact.CarExtender} from the CarExtender options of an existing Notification.
//         *
...
//                mColor = carBundle.getInt(EXTRA_COLOR, CustomNotificationCompact.COLOR_DEFAULT);
//
...
//        @RequiresApi(21)
//        @SuppressWarnings("deprecation")
//        private static CustomNotificationCompact.CarExtender.UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle b) {
//            if (b == null) {
//                return null;
//            }
...
//                    : null;
//
//            return new CustomNotificationCompact.CarExtender.UnreadConversation(messages, remoteInputCompat, onReply,
//                    onRead, participants, b.getLong(KEY_TIMESTAMP));
//        }
//
//        @RequiresApi(21)
//        private static Bundle getBundleForUnreadConversation(@NonNull CustomNotificationCompact.CarExtender.UnreadConversation uc) {
//            Bundle b = new Bundle();
//            String author = null;
...
//         * the {@link CustomNotificationCompact.Builder#extend(CustomNotificationCompact.Extender)}
//         * method of {@link CustomNotificationCompact.Builder}.
//         */
//        @Override
//        @NonNull
//        public CustomNotificationCompact.Builder extend(@NonNull CustomNotificationCompact.Builder builder) {
...
//            }
//            if (mColor != CustomNotificationCompact.COLOR_DEFAULT) {
...
//         *
//         * Android Auto uses the color set with {@link CustomNotificationCompact.Builder#setColor(int)}
//         * to accent the displayed notification. However, not all colors are acceptable in an
//         * automotive setting. This method can be used to override the color provided in the
//         * notification in such a situation.
//         */
//        public @NonNull
//        CustomNotificationCompact.CarExtender setColor(@ColorInt int color) {
//            mColor = color;
//            return this;
//        }
//
...
//         * specified by {@link CustomNotificationCompact.Builder#setLargeIcon(android.graphics.Bitmap)}
//         *
//         * @param largeIcon The large icon to use in the car notification.
//         * @return This object for method chaining.
//         */
//        public @NonNull
//        CustomNotificationCompact.CarExtender setLargeIcon(@Nullable Bitmap largeIcon) {
...
//         * @see CustomNotificationCompact.CarExtender#setLargeIcon
//         */
...
//         * @return This object for method chaining.
//         *
//         * @deprecated {@link CustomNotificationCompact.CarExtender.UnreadConversation} is no longer supported. Use {@link CustomNotificationCompact.MessagingStyle}
//         * instead.
//         */
//        @Deprecated
//        @NonNull
//        public CustomNotificationCompact.CarExtender setUnreadConversation(@Nullable CustomNotificationCompact.CarExtender.UnreadConversation unreadConversation) {
...
//         * @see #setUnreadConversation(CustomNotificationCompact.CarExtender.UnreadConversation)
//         *
//         * @deprecated {@link CustomNotificationCompact.CarExtender.UnreadConversation} is no longer supported. Use {@link CustomNotificationCompact.MessagingStyle}
//         * instead.
//         */
//        @Deprecated
//        public @Nullable
//        CustomNotificationCompact.CarExtender.UnreadConversation getUnreadConversation() {
...
//
//            /**
//             * Builder class for {@link CustomNotificationCompact.CarExtender.UnreadConversation} objects.
//             */
//            public static class Builder {
...
//
//                /**
//                 * Constructs a new builder for {@link CustomNotificationCompact.CarExtender.UnreadConversation}.
//                 *
...
//                 */
//                public @NonNull
//                CustomNotificationCompact.CarExtender.UnreadConversation.Builder addMessage(@Nullable String message) {
//                    if (message != null) {
//                        mMessages.add(message);
//                    }
//                    return this;
...
//                 * @return This object for method chaining.
//                 *
//                 * @see CustomNotificationCompact.CarExtender.UnreadConversation#getRemoteInput
//                 * @see CustomNotificationCompact.CarExtender.UnreadConversation#getReplyPendingIntent
//                 */
//                public @NonNull
//                CustomNotificationCompact.CarExtender.UnreadConversation.Builder setReplyAction(@Nullable PendingIntent pendingIntent,
...
//                 */
//                public @NonNull
//                CustomNotificationCompact.CarExtender.UnreadConversation.Builder setReadPendingIntent(
...
//                 */
//                public @NonNull
//                CustomNotificationCompact.CarExtender.UnreadConversation.Builder setLatestTimestamp(long timestamp) {
...
//                 */
//                public @NonNull
//                CustomNotificationCompact.CarExtender.UnreadConversation build() {
//                    String[] messages = mMessages.toArray(new String[mMessages.size()]);
//                    String[] participants = { mParticipant };
//                    return new CustomNotificationCompact.CarExtender.UnreadConversation(messages, mRemoteInput, mReplyPendingIntent,
...
//     * {@link CustomNotificationCompact.BubbleMetadata.Builder#setIcon(IconCompat)} and an expanded state which is populated
//     * via {@link CustomNotificationCompact.BubbleMetadata.Builder#setIntent(PendingIntent)}.</p>
//     *
...
//     *
//     * @see CustomNotificationCompact.Builder#setBubbleMetadata(CustomNotificationCompact.BubbleMetadata)
//     */
...
//         * null if this bubble is created via {@link CustomNotificationCompact.BubbleMetadata.Builder#Builder(String)}.
//         */
...
//         * {@link CustomNotificationCompact.BubbleMetadata.Builder#Builder(String)} or null if created via
//         * {@link CustomNotificationCompact.BubbleMetadata.Builder#Builder(PendingIntent, IconCompat)}.
//         */
//        @Nullable
...
//         * if the bubble is created via {@link CustomNotificationCompact.BubbleMetadata.Builder#Builder(String)}.
//         */
//        @SuppressLint("InvalidNullConversion")
//        @Nullable
...
//         *
//         * @see CustomNotificationCompact.BubbleMetadata.Builder#setAutoExpandBubble(boolean)
//         */
...
//         *
//         * @see CustomNotificationCompact.BubbleMetadata.Builder#setSuppressNotification(boolean)
//         */
...
//
//        /**
//         * Converts a {@link CustomNotificationCompact.BubbleMetadata} to a platform-level
...
//                @Nullable CustomNotificationCompact.BubbleMetadata compatMetadata) {
//            if (compatMetadata == null) {
//                return null;
//            }
//            if (Build.VERSION.SDK_INT >= 30) {
//                return CustomNotificationCompact.BubbleMetadata.Api30Impl.toPlatform(compatMetadata);
//            } else if (Build.VERSION.SDK_INT == 29) {
//                return CustomNotificationCompact.BubbleMetadata.Api29Impl.toPlatform(compatMetadata);
//            }
//            return null;
//        }
//
...
//         * {@link CustomNotificationCompact.BubbleMetadata}.
//         *
//         * @param platformMetadata the {@link Notification.BubbleMetadata} to convert
//         * @return a {@link CustomNotificationCompact.BubbleMetadata} containing the same data if
//         * platformMetadata is non-null, otherwise null.
//         */
//        public static @Nullable
//        CustomNotificationCompact.BubbleMetadata fromPlatform(
//                @Nullable android.app.Notification.BubbleMetadata platformMetadata) {
//            if (platformMetadata == null) {
//                return null;
//            }
//            if (Build.VERSION.SDK_INT >= 30) {
//                return CustomNotificationCompact.BubbleMetadata.Api30Impl.fromPlatform(platformMetadata);
//            } else if (Build.VERSION.SDK_INT == 29) {
//                return CustomNotificationCompact.BubbleMetadata.Api29Impl.fromPlatform(platformMetadata);
//            }
//            return null;
//        }
//
//        /**
//         * Builder to construct a {@link CustomNotificationCompact.BubbleMetadata} object.
//         */
//        public static final class Builder {
//
//            private PendingIntent mPendingIntent;
...
//
//            /**
//             * Creates a {@link CustomNotificationCompact.BubbleMetadata.Builder} based on a {@link ShortcutInfoCompat}. To
...
//
//            /**
//             * Creates a {@link CustomNotificationCompact.BubbleMetadata.Builder} based on the provided intent and icon.
//             *
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setIntent(@NonNull PendingIntent intent) {
//                if (mShortcutId != null) {
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setIcon(@NonNull IconCompat icon) {
//                if (mShortcutId != null) {
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setDesiredHeight(@Dimension(unit = DP) int height) {
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setDesiredHeightResId(@DimenRes int heightResId) {
//                mDesiredHeightResId = heightResId;
//                mDesiredHeight = 0;
//                return this;
//            }
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setAutoExpandBubble(boolean shouldExpand) {
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setSuppressNotification(
...
//             */
//            @NonNull
//            public CustomNotificationCompact.BubbleMetadata.Builder setDeleteIntent(@Nullable PendingIntent deleteIntent) {
//                mDeleteIntent = deleteIntent;
//                return this;
//            }
//
//            /**
//             * Creates the {@link CustomNotificationCompact.BubbleMetadata} defined by this builder.
//             * <p>Will throw {@link NullPointerException} if required fields have not been set
//             * on this builder.</p>
//             */
//            @NonNull
//            @SuppressLint("SyntheticAccessor")
//            public CustomNotificationCompact.BubbleMetadata build() {
...
//                }
//                CustomNotificationCompact.BubbleMetadata data = new CustomNotificationCompact.BubbleMetadata(mPendingIntent, mDeleteIntent,
...
//
//            @NonNull
//            private CustomNotificationCompact.BubbleMetadata.Builder setFlag(int mask, boolean value) {
//                if (value) {
//                    mFlags |= mask;
//                } else {
//                    mFlags &= ~mask;
...
//             */
//            @RequiresApi(29)
//            @Nullable static CustomNotificationCompact.BubbleMetadata fromPlatform(
//                    @Nullable android.app.Notification.BubbleMetadata platformMetadata) {
//                if (platformMetadata == null) {
//                    return null;
//                }
...
//                    return null;
//                }
//                CustomNotificationCompact.BubbleMetadata.Builder compatBuilder =
//                        new CustomNotificationCompact.BubbleMetadata.Builder(platformMetadata.getIntent(),
...
//                }
//
//                CustomNotificationCompact.BubbleMetadata.Builder compatBuilder = null;
//                if (platformMetadata.getShortcutId() != null) {
//                    compatBuilder = new CustomNotificationCompact.BubbleMetadata.Builder(platformMetadata.getShortcutId());
//                } else {
//                    compatBuilder = new CustomNotificationCompact.BubbleMetadata.Builder(platformMetadata.getIntent(),
//                            IconCompat.createFromIcon(platformMetadata.getIcon()));
//                }
//                compatBuilder
//                        .setAutoExpandBubble(platformMetadata.getAutoExpandBubble())
...
//    @SuppressWarnings("deprecation")
//    public static @Nullable
//    CustomNotificationCompact.Action getAction(@NonNull Notification notification, int actionIndex) {
//        if (Build.VERSION.SDK_INT >= 20) {
...
//
//    /**
//     * Get the {@link CustomNotificationCompact.BubbleMetadata} for a notification that will be used to display app content in
...
//     */
//    public static @Nullable
//    CustomNotificationCompact.BubbleMetadata getBubbleMetadata(@NonNull Notification notification) {
//        if (Build.VERSION.SDK_INT >= 29) {
//            return CustomNotificationCompact.BubbleMetadata.fromPlatform(notification.getBubbleMetadata());
//        } else {
//            return null;
//        }
//    }
...
//    @RequiresApi(20)
//    static @NonNull
//    CustomNotificationCompact.Action getActionCompatFromAction(@NonNull Notification.Action action) {
...
//                action.getExtras().getBoolean(CustomNotificationCompact.Action.EXTRA_SHOWS_USER_INTERFACE, true);
//
//        final @CustomNotificationCompact.Action.SemanticAction int semanticAction;
//        if (Build.VERSION.SDK_INT >= 28) {
//            semanticAction = action.getSemanticAction();
//        } else {
//            semanticAction = action.getExtras().getInt(
//                    CustomNotificationCompact.Action.EXTRA_SEMANTIC_ACTION, CustomNotificationCompact.Action.SEMANTIC_ACTION_NONE);
//        }
//
...
//                return new CustomNotificationCompact.Action(action.icon, action.title, action.actionIntent,
...
//            return new CustomNotificationCompact.Action(icon, action.title, action.actionIntent, action.getExtras(),
//                    remoteInputs, null, allowGeneratedReplies, semanticAction, showsUserInterface,
//                    isContextual, authRequired);
//        } else {
//            return new CustomNotificationCompact.Action(action.icon, action.title, action.actionIntent, action.getExtras(),
//                    remoteInputs, null, allowGeneratedReplies, semanticAction, showsUserInterface,
//                    isContextual, authRequired);
//        }
//    }
...
//    @RequiresApi(21)
//    public static @NonNull List<CustomNotificationCompact.Action> getInvisibleActions(@NonNull Notification notification) {
//        ArrayList<CustomNotificationCompact.Action> result = new ArrayList<>();
//        if (Build.VERSION.SDK_INT >= 19) {
//            Bundle carExtenderBundle =
//                    notification.extras.getBundle(CustomNotificationCompact.CarExtender.EXTRA_CAR_EXTENDER);
//            if (carExtenderBundle == null) {
//                return result;
//            }
//
//            Bundle listBundle = carExtenderBundle.getBundle(CustomNotificationCompact.CarExtender.EXTRA_INVISIBLE_ACTIONS);
//            if (listBundle != null) {
...
//     * {@link Person} objects will contain only the URI from {@link CustomNotificationCompact.Builder#addPerson(String)}.
//     */
//    @SuppressWarnings("deprecation")
...
//    }
//
//    /** Returns the content title provided to {@link CustomNotificationCompact.Builder#setContentTitle(CharSequence)}. */
//    @RequiresApi(19)
//    public static @Nullable CharSequence getContentTitle(@NonNull Notification notification) {
//        return notification.extras.getCharSequence(EXTRA_TITLE);
//    }
//
//    /** Returns the content text provided to {@link CustomNotificationCompact.Builder#setContentText(CharSequence)}. */
//    @RequiresApi(19)
//    public static @Nullable CharSequence getContentText(@NonNull Notification notification) {
//        return notification.extras.getCharSequence(EXTRA_TEXT);
//    }
//
//    /** Returns the content info provided to {@link CustomNotificationCompact.Builder#setContentInfo(CharSequence)}. */
//    @RequiresApi(19)
//    public static @Nullable CharSequence getContentInfo(@NonNull Notification notification) {
//        return notification.extras.getCharSequence(EXTRA_INFO_TEXT);
//    }
//
//    /** Returns the sub text provided to {@link CustomNotificationCompact.Builder#setSubText(CharSequence)}. */
//    @RequiresApi(19)
...
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setShowWhen(boolean)} */
//    @RequiresApi(19)
...
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setUsesChronometer(boolean)} */
//    @RequiresApi(19)
...
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setOnlyAlertOnce(boolean)} */
//    public static boolean getOnlyAlertOnce(@NonNull Notification notification) {
//        return (notification.flags & Notification.FLAG_ONLY_ALERT_ONCE) != 0;
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setAutoCancel(boolean)} */
//    public static boolean getAutoCancel(@NonNull Notification notification) {
//        return (notification.flags & Notification.FLAG_AUTO_CANCEL) != 0;
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setOngoing(boolean)} */
//    public static boolean getOngoing(@NonNull Notification notification) {
//        return (notification.flags & Notification.FLAG_ONGOING_EVENT) != 0;
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setColor(int)} */
...
//    }
//
//    /** Get the value provided to {@link CustomNotificationCompact.Builder#setVisibility(int)} */
//    public static @CustomNotificationCompact.NotificationVisibility
//    int getVisibility(@NonNull Notification notification) {
//        if (Build.VERSION.SDK_INT >= 21) {
...
//     * Grouped notifications may display in a cluster or stack on devices which
//     * support such rendering. Requires a group key also be set using {@link CustomNotificationCompact.Builder#setGroup}.
...
//
//    /**
//     * Returns the settings text provided to {@link CustomNotificationCompact.Builder#setSettingsText(CharSequence)}.
//     */
