...
class AtomButton2 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private fun updateText() {
        ...
        if ((this@AtomButton2).text?.isNotBlank() == true && (this@AtomButton2).text?.isNotEmpty() == true) {
